...
<div class="card" style="margin:20px;">
  ...
  <div class="card-body">
      ...
      <form action="{{url('shop/Products/'.$Product->id)}}" method="post" enctype="multipart/form-data">
        <!-- {!! csrf_field() !!} -->
        @csrf
        @method("PATCH")
        ...
        <div class="row">
            ...
            <div class="row gx-3 mb-3">
                ...
                <input type="text" name="ProductName" id="ProductName" class="form-control" value="{{$Product->Name}}" ></br>
            ...
            <div class="row gx-3 mb-3">    
                ...
                <input type="text" name="ProductMakeIN" id="ProductMakeIN" class="form-control" value="{{$Product->Made_IN}}" >
                ...
                <input type="text" name="ProductCondiction" id="ProductCondiction" class="form-control" value="{{$Product->Condiction}}" >
            ...
            <div class="row gx-3 mb-3">    
                ...
                <input type="text" name="Warranty" id="Warranty" class="form-control" value="{{$Product->Warranty}}">
            ...
            <div class="card-body text-center">
                    ...
                    <br>
                    <img class="img-account-profile" id="blah" src="{{asset('uploads/Products/'.$shopsProfile->Name.'/'.$Product->Picture)}}" width="300px" height="300px" alt="">
