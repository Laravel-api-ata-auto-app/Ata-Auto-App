<div class="card" style="margin:20px;">
  ...
  <div class="card-body">
      ...
      <form action="{{  url('shop/Profile/'.Auth::user()->id) }}" method="post" enctype="multipart/form-data">
        <!-- {!! csrf_field() !!} -->
        @csrf
        @method("PATCH")
        <div class="row">
            ...
            <div class="row gx-3 mb-3">    
                ...
                <input type="text" name="ShopName" id="ShopName" class="form-control" value="{{$shopsProfile->Name}}"></br>
                ...
                <input type="text" name="ContactName" id="ContactName" class="form-control" value="{{$shopsProfile->Contact_Name}}" ></br>
            ...
            <div class="row gx-3 mb-3">    
                ...
                <input type="text" name="ContactNumber" id="ContactNumber" class="form-control" value="{{$shopsProfile->Contact_Number}}" ></br>
                ...
                <input type="text" name="FaceBook" id="FaceBook" class="form-control" value="{{$shopsProfile->Facebooks}}"></br>
            ...
            <div class="row gx-3 mb-3">    
                ...
                <input type="text" name="Telegram" id="Telegram" class="form-control" value="{{$shopsProfile->Telegram}}" ></br>
            ...
            <div class="card-body text-center">
                    ...
                    <br>
                    <img class="img-account-profile rounded-circle" id="blah" src="{{asset('uploads/Shop/'.$shopsProfile->Picture)}}" width="300px" height="300px" alt="">
